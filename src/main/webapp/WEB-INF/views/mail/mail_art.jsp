...
<table align="center">
	<tr>
		<td width="550px;">
			<form class="Find" action="matching_art" method="get">
				<h1>아이디 찾기</h1>
				<hr>
				<label for="fname">이름</label><br> <input id="input" type="text"
					name="a_username" placeholder="이름"><br> <label
					for="fname">E-Mail</label><br> <input id="input" type="text"
					name="a_email1" placeholder="이메일"> @ <input id="input"
					type="text" name="a_email2" placeholder="이메일"> <br> <input
